...
class CatalogueCollectionDataProvider implements ContextAwareCollectionDataProviderInterface, RestrictedDataProviderInterface
{
    //private CatalogueDataInterface $repository;
