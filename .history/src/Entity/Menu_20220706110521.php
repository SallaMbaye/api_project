...
/* 
   ...
   /*  #[ORM\ManyToMany(targetEntity: Taille::class, inversedBy: 'menus')]
    ...
    #[ORM\ManyToMany(targetEntity: MenuFrite::class, inversedBy: 'menus')]
    #[Groups(["read:menu","affiche"])]
    private $menufrites;

    #[ORM\ManyToMany(targetEntity: MenuTaille::class, inversedBy: 'menus')]
    #[Groups(["read:menu","affiche"])]
    private $menutailles;

    #[ORM\ManyToMany(targetEntity: MenuBurger::class, inversedBy: 'menus',cascade:[])]
    private $menuburgers;
